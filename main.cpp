...
int main(int argc, char *argv[]){
    ...
    QObject::connect(&g, SIGNAL(player4_start(positions_and_dice)),&p5,SLOT(start_turn(positions_and_dice)));
    QObject::connect(&p5,SIGNAL(select_piece(int)),                &g, SLOT(movePiece(int)));
